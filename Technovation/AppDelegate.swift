...
//
//
//        if let mainVC = storyboard.instantiateViewController(withIdentifier: "MainVC") as? MainViewController{
...
//            mainVC.performSegue(withIdentifier: "segueToSideMenu", sender: self)
